...
{
    options.AppId = "1217270592197836";
    options.AppSecret = "c50038bee73bc71fa092dac89ca657c2";
});

//Mandotory for [Authorize]-when we want to Restrict directly access to Any Action
